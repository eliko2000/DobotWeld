...
function MingTuProtocol.connect(ip,port)
    local self = MingTuProtocol
    local tPort = port
...
function MingTuProtocol.isConnected()
    local self = MingTuProtocol
    return nil~=self.id
end
...
function MingTuProtocol.disconnect()
    local self = MingTuProtocol
    if nil~=self.id then
        ModbusClose(self.id)
        self.id = nil
...
function MingTuProtocol.setTaskNumber(num)
    local self = MingTuProtocol
...
function MingTuProtocol.openLaser()
    local self = MingTuProtocol
    local ret = SetHoldRegs(self.id, 0x0001, 1, {0x00FF}, "U16")
    return 0==ret
end
function MingTuProtocol.closeLaser()
    local self = MingTuProtocol
...
function MingTuProtocol.startPosition()
    local self = MingTuProtocol
    local ret = SetHoldRegs(self.id, 0x0002, 1, {0x00FF}, "U16")
    return 0==ret
end
function MingTuProtocol.stopPosition()
    local self = MingTuProtocol
...
function MingTuProtocol.startTrack()
    local self = MingTuProtocol
    local ret = SetHoldRegs(self.id, 0x0003, 1, {0x00FF}, "U16")
    return 0==ret
end
function MingTuProtocol.stopTrack()
    local self = MingTuProtocol
...
function MingTuProtocol.getLaserPose()
    local self = MingTuProtocol
...
function MingTuProtocol.getToolPose()
    local self = MingTuProtocol
...
function MingTuProtocol.setRobotPose(pose)
    local self = MingTuProtocol
    local sendData = {}
    ...
    local ret = SetHoldRegs(self.id, 0x0020, #sendData, sendData, "U16")
    return 0==ret
end
...
function MingTuProtocol.isDetectSuccess()
    local self = MingTuProtocol
...
function MingTuProtocol.getGapValue()
    local self = MingTuProtocol
...
function MingTuProtocol.getOffsetValue()
    local self = MingTuProtocol
...
function MingTuProtocol.getSqureValue()
    local self = MingTuProtocol
