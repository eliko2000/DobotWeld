--[[焊机MIG-LST型号接口DeviceNet类，继承`AotaiWelderControlDeviceNet`]]--

local AotaiWelderMigLstControlDeviceNet = AotaiWelderControlDeviceNet:new()
AotaiWelderMigLstControlDeviceNet.__index = AotaiWelderMigLstControlDeviceNet

function AotaiWelderMigLstControlDeviceNet:new(welderObj)
    local o = AotaiWelderControlDeviceNet:new(welderObj)
    return setmetatable(o,self)
end

function AotaiWelderMigLstControlDeviceNet:setWeldMode(newVal)
...
return AotaiWelderMigLstControlDeviceNet