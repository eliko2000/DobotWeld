--[[焊机MIG-LST型号接口DeviceNet类，继承`AotaiWelderControlModbus`]]--

local AotaiWelderMigLstControlModbus = AotaiWelderControlModbus:new()
AotaiWelderMigLstControlModbus.__index = AotaiWelderMigLstControlModbus

function AotaiWelderMigLstControlModbus:new(welderObj)
    local o = AotaiWelderControlModbus:new(welderObj)
    return setmetatable(o,self)
end

function AotaiWelderMigLstControlModbus:setWeldMode(newVal)
    ...
    local mapper = {
        ...
        lowSplash = 0x03, --低飞溅模式
        flatSpotWeld = 0x05, --平特性点焊
        pulseSpotWeld = 0x06, --脉冲点焊
        lowSplashSpotWeld = 0x07 --低飞溅点焊
    }
...
return AotaiWelderMigLstControlModbus