--[[焊机MIG-PLUS型号接口DeviceNet类，继承`AotaiWelderControlModbus`]]--

local AotaiWelderMigPlusControlModbus = AotaiWelderControlModbus:new()
AotaiWelderMigPlusControlModbus.__index = AotaiWelderMigPlusControlModbus

function AotaiWelderMigPlusControlModbus:new(welderObj)
    local o = AotaiWelderControlModbus:new(welderObj)
    return setmetatable(o,self)
end

function AotaiWelderMigPlusControlModbus:setWeldMode(newVal)
...
return AotaiWelderMigPlusControlModbus