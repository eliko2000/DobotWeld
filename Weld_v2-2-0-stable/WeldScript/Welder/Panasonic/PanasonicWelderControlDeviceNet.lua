...
-------------------------------------------------------------------------------------------------------------------
--【业务实现接口】-------------------------------------------------------------------------------------------------
local PanasonicWelderControlDeviceNet = WelderControlDeviceNet:new()
PanasonicWelderControlDeviceNet.__index = PanasonicWelderControlDeviceNet
...
-------------------------------------------------------------------------------------------------------------------
--【对外公开接口】-------------------------------------------------------------------------------------------------
function PanasonicWelderControlDeviceNet:new(welderObj)
...
function PanasonicWelderControlDeviceNet:initWelder()
    --[[
...
function PanasonicWelderControlDeviceNet:notifyWelderThatRobotHasReady()
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:notifyWelderThatRobotNotReady()
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:isWelderReady()
...
function PanasonicWelderControlDeviceNet:setWeldCurrent(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
...
function PanasonicWelderControlDeviceNet:setArcStartCurrent(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
        local params = self.welderObject:getWelderParamObject():getNotJobModeParam()
        if #params.params < 1 or params.selectedId<1 or params.selectedId > #params.params then
...
function PanasonicWelderControlDeviceNet:setArcEndCurrent(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
        local params = self.welderObject:getWelderParamObject():getNotJobModeParam()
        if #params.params < 1 or params.selectedId<1 or params.selectedId > #params.params then
...
function PanasonicWelderControlDeviceNet:getWeldCurrent()
...
function PanasonicWelderControlDeviceNet:setWeldVoltage(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
        local params = self.welderObject:getWelderParamObject():getNotJobModeParam()
        if #params.params < 1 or params.selectedId<1 or params.selectedId > #params.params then
...
function PanasonicWelderControlDeviceNet:setArcStartVoltage(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
        local params = self.welderObject:getWelderParamObject():getNotJobModeParam()
        if #params.params < 1 or params.selectedId<1 or params.selectedId > #params.params then
...
function PanasonicWelderControlDeviceNet:setArcEndVoltage(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
        local params = self.welderObject:getWelderParamObject():getNotJobModeParam()
        if #params.params < 1 or params.selectedId<1 or params.selectedId > #params.params then
...
function PanasonicWelderControlDeviceNet:getWeldVoltage()
...
function PanasonicWelderControlDeviceNet:getWeldWireFeedSpeed()
...
function PanasonicWelderControlDeviceNet:setWeldMode(newVal)
    local welderName = self.welderObject.welderName
    local params = newVal
    if nil == params then
...
function PanasonicWelderControlDeviceNet:setJobId(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
...
function PanasonicWelderControlDeviceNet:setProcessNumber(newVal)
    local welderName = self.welderObject.welderName
    if nil == newVal then
        local params = self.welderObject:getWelderParamObject():getJobModeParam()
...
function PanasonicWelderControlDeviceNet:arcStart()
    local newVal = 0x01
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:isArcStarted()
    local welderName = self.welderObject.welderName
    local newVal = self:innerGetInRegsValue_Address(0) or {}
    if #newVal<1 then
...
function PanasonicWelderControlDeviceNet:arcEnd()
    local newVal = 0xFFFE
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:isArcEnded()
    local welderName = self.welderObject.welderName
    local newVal = self:innerGetInRegsValue_Address(0) or {}
    if #newVal<1 then
...
function PanasonicWelderControlDeviceNet:hasEndArcByMannual()
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:clearError()
    local newVal = 0x2000
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:startWireFeed()
    local newVal = 0x0200
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:stopWireFeed()
    local newVal = 0xFDFF
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:startWireBack()
    local newVal = 0x0400
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:stopWireBack()
    local newVal = 0xFBFF
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:isStickRelease()
...
function PanasonicWelderControlDeviceNet:startGasCheck()
    local newVal = 0x0100
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:stopGasCheck()
    local newVal = 0xFEFF
    local welderName = self.welderObject.welderName
...
function PanasonicWelderControlDeviceNet:getWelderRunStateInfo()
...
function PanasonicWelderControlDeviceNet:getWelderErrCode()
    local newVal = self:innerGetInRegsValue_Address(0) or {}
    if #newVal<1 then
        local welderName = self.welderObject.welderName
...
return PanasonicWelderControlDeviceNet