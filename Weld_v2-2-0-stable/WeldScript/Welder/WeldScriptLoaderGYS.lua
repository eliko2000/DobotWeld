...
local requireModuleCacheList = {
    "Welder.GYS.GYSWelder",
    "Welder.GYS.GYSWelderControlModbus"
}
...
GYSWelder = require("Welder.GYS.GYSWelder")
GYSWelderControlModbus = require("Welder.GYS.GYSWelderControlModbus")